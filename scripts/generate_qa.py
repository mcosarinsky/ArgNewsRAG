...
def generate_query_prompt(sample):
    prompt = "En base al artículo dado a continuación debes generar una pregunta puntual sobre el tema central del artículo junto a su respuesta. La respuesta debe ser breve, precisa y contener a lo sumo una frase que respondan de forma directa a la pregunta. La pregunta puede incluir referencias temporales pero evita poner fechas salvo que sea imprescindible y debe ser lo suficientemente clara como para que un experto que no haya leído el artículo pueda responderla. La respuesta debe ser precisa y concisa, sin necesidad de elaborar explicaciones largas. Las respuestas deben basarse en el contenido del artículo y reflejar un conocimiento general sobre el tema.\nEl formato de salida debe ser el siguiente: {'Pregunta': [...], 'Respuesta': [...]}"
